...
const NOTE_TYPES = [
    { id: "Note", labelKey: "notes", icon: FileText },
    { id: "Idea", labelKey: "idea", icon: Lightbulb },
    { id: "Pinned", labelKey: "pinned", icon: Pin },
    { id: "Study", labelKey: "study", icon: BookOpen },
] as const;
    ...
    return (
        <div className="flex flex-col h-[85vh] md:h-full bg-background rounded-t-[32px] md:rounded-3xl border border-border overflow-hidden">
            ...
            <div className="flex justify-between items-center p-6 pb-4 border-b border-border/50">
                <h2 className="text-2xl font-bold text-foreground">{isEditing ? t("editNote") : t("newNote")}</h2>
            ...
            >
                ...
                {/* Content */}
                <div className="space-y-2">
                    <label className="text-xs uppercase font-bold tracking-widest text-muted-foreground ml-1">{t("content")}</label>
                    <textarea
                ...
                <div className="pt-4 pb-2">
                    ...
                    >
                        {isEditing ? t("saveChanges") : t("newNote")}
                    </Button>
                </div>
            </form>
        </div>
